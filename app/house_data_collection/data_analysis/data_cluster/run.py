...
def loadDataset():
    ...
    #合并经纬度数据
    df_latlng = pd.read_csv("../../data/gz_latlng.csv",skiprows=[0],names=["did","id","communityName","lat","lng"])
    del df_latlng["did"]
...
plt.savefig('../../data/不同k值下的SSE(Sum of squared errors)平方误差和.png')
...
plt.savefig('../../data/广州二手房单价与建筑面积散点图.png')
...
plt.show()
plt.savefig('../../data/广州二手房总价与建筑面积散点图.png')


"""6、生成地图文件"""
count = 0
for data_map in data_df:
    out_map = "../../data/gz_cluster"+str(count)+".js"
