...
mean_unitprice.plot(kind="bar",fontsize=12, color='g')
...
plt.savefig('../../../../static/images/广州各区域二手房单价箱线图.png')
...
plt.savefig('../../../../static/images/广州各区域二手房总价箱线图.png')
...
mean_jzmj.plot(kind="bar",fontsize=12, color='g')
...
mean_jzmj.plot(kind="bar",ax=ax2,fontsize=12, color='g')
...
plt.savefig('../../../../static/images/广州二手房单价最高Top20.png')
...
ax.set_ylabel("总价(万元)",fontsize=14)
plt.savefig('../../../../static/images/广州二手房总价与建筑面积散点图.png')
...
ax.set_ylabel("单价(元/平米)",fontsize=14)
plt.show()
plt.savefig('../../../../static/images/广州二手房单价与建筑面积散点图.png')
