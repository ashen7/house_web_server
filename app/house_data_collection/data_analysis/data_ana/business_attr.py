...
def business_attr_api():
        ...
        """1、数据加载"""
        #定义加载数据的文件名
        # filename = "app/house_data_collection/data/广州二手房清洗后数据.csv"
        ...
        count_fwyt.plot(kind="barh",fontsize=12, color='g')
        # plt.show()
        plt.savefig('../../../../static/images/广州二手房房屋用途水平柱状图www.png')
